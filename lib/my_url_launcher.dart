...
class MyUrlLauncherPage extends StatefulWidget {
  const MyUrlLauncherPage({Key? key,  this.title}) : super(key: key);
  final String? title;

  @override
  State<MyUrlLauncherPage> createState() => _MyUrlLauncherPageState();
}

class _MyUrlLauncherPageState extends State<MyUrlLauncherPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final qP = Uri.parse(AppConstants.url);
    final Uri toLaunch =
    Uri(scheme: 'https',
        host:
        AppConstants.urlHost,
        // 'www.cylog.org',
        path:
        AppConstants.urlPath,
        // 'headers/'
